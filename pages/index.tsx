...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Navbar classes="absolute top-0 h-[4.5rem] z-20">
      ...
      <section className="home bg-secondary-8 dark:bg-secondary-7">
        <div className="container max-w-[1176px] px-6 h-full flex items-center gap-2">
          ...
          <div className="lg:basis-4/12 bg-secondary-3 h-[400px]"></div>
        </div>
      </section>
      ...
      <section className="blog py-16 bg-secondary-8 dark:bg-secondary-7">
      ...
      <section className="contacts bg-primary-2 dark:bg-primary-3 py-16">
