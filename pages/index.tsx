          ...
          <ul className="hidden lg:flex items-center gap-16">
            <li>
              <a
                ...
                className="text-secondary-7/90 dark:text-primary-2/90 hover:text-secondary-1 hover:dark:text-secondary-1 transition duration-[250] ease-in-out cursor-pointer"
              >
                About
              </a>
            </li>
          ...
          <div className="basis-10/12 lg:basis-8/12">
            <div className="flex flex-col space-y-8">
              ...
              <p className="text-secondary-7/80 dark:text-primary-2/80">
                ...
                <span className="text-secondary-1">optimizing</span>{" "}
                production-level backend APIs as well as seamless front-end.
              </p>
              <Link href="/Mucyo-Christian-Resume.pdf">
                <a target="_blank">
                  <Button
                    type="button"
            ...
            <div className="p-6 bg-secondary-1/10 dark:bg-secondary-7 rounded">
              <div className="relative flex flex-col gap-4 rounded transition">
                ...
                <div className="flex flex-col space-y-4">
                  <Link href="https://expense-app-tracker.vercel.app">
                    <a
                      target="_blank"
                  ...
                  <p className="text-sm text-secondary-7/80 dark:text-primary-2/80">
                    A web-based application designed to manage personal expenses
            ...
            <div className="p-6 bg-secondary-1/10 dark:bg-secondary-7 rounded">
              <div className="relative flex flex-col gap-4 rounded transition">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <p className="text-sm text-secondary-7/80 dark:text-primary-2/80">
                    A web-based platform created to connect clients with highly
                    skilled freelancers for job opportunities.
                  </p>
                  <div className="flex space-x-2 overflow-x-hidden">
                    <div className="px-3 py-1.5 rounded-lg flex justify-center bg-secondary-1/60 dark:bg-secondary-3">
                      <h6 className="text-secondary-3 dark:text-secondary-1 text-xs font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-12 gap-x-8 gap-y-10">
            <div className="relative flex flex-col gap-4 rounded-lg transition">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <p className="text-sm text-secondary-7/80 dark:text-primary-2/80">
                  I explain comprehensively RabbitMQ, covering its operation and
                  configuration. Additionally, I explored the concept of
                  monorepo, including its setup and advantages, particularly in
